            ...
            {[
              {
                icon: 'fas fa-crown',
                name: '记忆大师',
                gradient: 'linear-gradient(135deg, #ffd700 0%, #fff8c9 100%)'
              },
              {
                icon: 'fas fa-calendar-check',
                name: '七日连胜',
                gradient: 'linear-gradient(135deg, #c0c0c0 0%, #e0e0e0 100%)'
              },
              {
                icon: 'fas fa-book-reader',
                name: '阅读新星',
                gradient: 'linear-gradient(135deg, #cd7f32 0%, #e0a95c 100%)'
              },
              {
                icon: 'fas fa-lightbulb',
                name: '问题大师',
                gradient: 'linear-gradient(135deg, #f72585 0%, #f78fb3 100%)'
              }
            ].map((medal, index) => (
        ...
        <div className="card">
          ...
          <div className="settings-list">
            {[
              ...
              { icon: 'fas fa-language', title: '语言设置', desc: '简体中文' }
            ].map((setting, index) => (
              <div
                key={index}
